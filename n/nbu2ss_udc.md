...
struct nbu2ss_udc {
    ...
    u8 ep0_buf[64];
    struct nbu2ss_ep ep[14];
    unsigned int softconnect;
    unsigned int vbus_active;
    unsigned int linux_suspended;
    unsigned int linux_resume;
    unsigned int usb_suspended;
    unsigned int remote_wakeup;
    unsigned int udc_enabled;
    unsigned int mA;
    u32 curr_config;
